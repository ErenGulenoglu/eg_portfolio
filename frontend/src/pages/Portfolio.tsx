      ...
      <main className="flex flex-col justify-center items-center w-full">
        <div className="flex flex-col w-[90vw] justify-center items-start my-8 lg:w-[80vw]">
          <TextFade onetime={true}>
            <h2 className="w-fit text-4xl roboto font-light bg-[#7469B6] p-1 rounded-xs mb-8">
              UI/UX Projects
            </h2>
          </TextFade>
          <div className="flex flex-col w-full justify-start items-center gap-16 lg:w-[80vw] lg:flex-row">
            <ProjectIntro
              image={work1}
              title="UTM Connect"
              description="High Fidelity UX/UI Design Case Study"
              color="#FEEAC9"
              rotate={0}
              link="/utm-connect-ux"
            />
