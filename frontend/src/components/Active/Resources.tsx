		...
		<div className="flex flex-col w-full justify-center items-center my-8 lg:w-[58em]">
			<div className="flex flex-row gap-4 w-full">
				...
				<div className="flex flex-row flex-wrap w-full justify-center items-center gap-4">
					<Link to="https://drive.google.com/file/d/1FvPGERhikQVmeOl54xbbyEbzgOj9jygP/view" target="_blank">
						<div className="flex flex-col h-18 w-18 justify-center items-center border border-muted-foreground rounded-md hover:bg-[#f5e8e8] transition-colors">
							...
							<span className="flex text-center text-sm text-muted-foreground justify-center items-center">Resume</span>
						</div>
					</Link>
					<Link to="https://www.linkedin.com/in/eren-gulenoglu-95690627b/" target="_blank">
						<div className="flex flex-col h-18 w-18 justify-center items-center border border-muted-foreground rounded-md hover:bg-[#f5e8e8] transition-colors">
							...
							<span className="flex text-center text-sm text-muted-foreground justify-center items-center">LinkedIn</span>
						</div>
					</Link>
					<Link to="https://github.com/ErenGulenoglu" target="_blank">
						<div className="flex flex-col h-18 w-18 justify-center items-center border border-muted-foreground rounded-md hover:bg-[#f5e8e8] transition-colors">
							...
							<span className="flex text-center text-sm text-muted-foreground justify-center items-center">Github</span>
						</div>
					</Link>
				</div>
			</div>
