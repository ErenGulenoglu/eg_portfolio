...
function NavigationBarMobile() {
	return (
		<div className="sticky top-0 flex w-full items-center justify-between px-[8vw] py-6 bg-muted/75 backdrop-blur-sm">
			<Link to="/" className="text-2xl font-bold text-[#7469B6] py-2">
				Eren Gulenoglu
			</Link>
			...
			<Sheet>
				...
				<SheetContent side="right">
					...
					<div className="grid flex-1 auto-rows-min gap-6 px-4">
						...
						<div className="grid gap-3">
							<a href="https://drive.google.com/file/d/1FvPGERhikQVmeOl54xbbyEbzgOj9jygP/view?usp=sharing" target="_blank" rel="noopener noreferrer">
						...
						<div className="grid gap-3">
							<a href="https://www.linkedin.com/in/eren-gulenoglu-95690627b/" target="_blank" rel="noopener noreferrer">
								<Button className="w-full cursor-pointer" variant="outline">
						...
						<div className="grid gap-3">
							<a href="https://github.com/ErenGulenoglu" target="_blank" rel="noopener noreferrer">
								<Button className="w-full cursor-pointer" variant="outline">
